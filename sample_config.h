...
const char* update_password = "OTAdigivent"; // change me if you want
...
/******* OTA **************/
int OTAport = 8266;
#define OTApassword "OTAvent" // change this to whatever password you want to use when you upload OTA
